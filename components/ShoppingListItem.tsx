...
interface CategoryItemProps {
  ...
  clearChecks: boolean;
  setEditModalVisible: React.Dispatch<SetStateAction<{status:boolean, item?: ParsedRecordShoppingListItem}>>
}

export default function ShoppingListItem({item, deleteMode, setItemsMarkedForDeletion, itemsMarkedForDeletion, saveMode, itemsMarkedForSaving, setItemsMarkedForSaving, clearChecks, setEditModalVisible }: CategoryItemProps) {
  ...
  const { id, name,amount, details } = item
  ...
  const handleEdit = (item:ParsedRecordShoppingListItem) => {
