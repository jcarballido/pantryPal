  ...
  return (
    <View className='flex flex-row items-center'>
      <View className={`w-1/2 min-h-[44] shrink flex flex-row justify-center bg-white rounded-full max-h-max items-center my-2 px-2 mx-4 ${isFocused? 'border-2 border-purple-600':''}`}>
        ...
        <TextInput value={value} placeholder='Search' onChangeText={setValue} className='bg-transparent w-full border-none outline-none ring-0' onFocus={handleFocus} onBlur={handleBlur} />
      </View>
